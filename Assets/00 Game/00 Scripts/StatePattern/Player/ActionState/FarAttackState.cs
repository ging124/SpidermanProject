...
public class FarAttackState : AttackState
{
    ...
    public void Zip()
    {
        ...
        _blackboard.playerController.SetLineRenderer(_rightLineRenderer, _blackboard.playerSkin.rightHand, _blackboard.playerController.enemyTarget.transform.position);
    }
