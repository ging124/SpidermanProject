...
public class ClimbMovementState : CanMoveState
{
    ...
    public void SetAnimancer()
    {
        ...
        {
            _climbBlendTree.State.Parameter = Mathf.Lerp(_climbBlendTree.State.Parameter, Vector3.Angle(_blackboard.playerController.transform.right, _blackboard.movement.normalized), 40 * Time.deltaTime);
        }
    }
}
