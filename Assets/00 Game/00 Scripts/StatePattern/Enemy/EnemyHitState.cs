...
public class EnemyHitState : EnemyNormalState
{
    ...
    {
        _blackboard.enemyController.characterController.Move((_blackboard.enemyController.transform.position - new Vector3(_blackboard.enemyController.target.transform.position.x, transform.position.y, _blackboard.enemyController.target.transform.position.z)).normalized * 0.5f);
