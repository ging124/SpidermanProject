...
public class EnemyCanMoveState : EnemyMovementState
{
    ...
    protected virtual void Movement(float speed)
    {
        ...
        {
            _blackboard.transform.forward = Vector3.Lerp(_blackboard.transform.forward, new Vector3(_blackboard.enemyController.movement.x, 0, _blackboard.enemyController.movement.z), _blackboard.enemyController.enemyData.rotateSpeed * Time.deltaTime);
        }
    }
